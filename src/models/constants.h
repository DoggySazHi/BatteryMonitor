...
#define EXCHANGE_TIME 1000
#define ACTIVITY_TIMEOUT 10000

#define INTERRUPT_MAX_DESYNC 2000
...
static const unsigned char GET_SETTINGS_INFO[] PROGMEM = "\xaa\x55\x90\xeb\x96\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10";
...
static const unsigned char PING_RESPONSE[] = { 0xaa, 0x55, 0x90, 0xeb };
static const unsigned char START_OF_RECORD[] = { 0x55, 0xaa, 0xeb, 0x90 };
